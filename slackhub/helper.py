...
def _admin_commands():
    return ('*Admin commands*\n'
            ...
            + '* `disable channel ([\\w-]+) repo ([\\w-]+) (all|label|maintainer|mention|pr|prefix)`'
            ...
            + '* `enable channel ([\\w-]+) repo ([\\w-]+) (all|label|maintainer|mention|pr|prefix)`'
...
def _user_commands():
    return ('*User commands*\n'
            ...
            + '* `disable repo ([\\w-]+) (all|label|maintainer|mention|pr|prefix)`'
            ...
            + '* `enable repo ([\\w-]+) (all|label|maintainer|mention|pr|prefix)`'
